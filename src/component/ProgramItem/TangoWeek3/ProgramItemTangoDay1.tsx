...
export default function ProgramItemTangoDay1({workout}){
    ...
    const getUser = async () => {
        ...
        .workoutName('eq', workout.mobility[0].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[1].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[2].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[3].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[0].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[1].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[2].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[3].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[4].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[5].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[6].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[7].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[8].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[0].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[1].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[2].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[3].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[4].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[0].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[1].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[2].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[3].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[4].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[5].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[6].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[7].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[8].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[9].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[10].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[11].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[12].name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
    ...
    const getDBUser = async (name, setValue) => {
        ...
        .workoutName('eq', name).day('eq', '1').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite').week('eq', '3').program('eq', 'Tango').level('eq', 'Elite'));
