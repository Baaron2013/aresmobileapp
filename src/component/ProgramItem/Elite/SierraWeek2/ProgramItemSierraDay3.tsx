...
export default function ProgramItemSierraDay3 ({workout}){
    ...
    const getUser = async () => {
        ...
        const newLog3 = await DataStore.query(Logs, c => c.userID ('eq', authUser.attributes.sub).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[0].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[1].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[0].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[1].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[2].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[0].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[0].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[1].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[2].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[3].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[4].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[5].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[6].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[7].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[8].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[9].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[10].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[11].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[12].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[13].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[14].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[15].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[16].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[17].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[18].name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    const getDBUser = async (name, setValue) => {
        ...
        .workoutName('eq', name).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    const save = async () => {
        ...
        const dbLog1 = await DataStore.query(Logs, c => c.userID ('eq', userID).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        const newLog1 = await DataStore.query(Logs, c => c.userID ('eq', userID).day('eq', '3').week('eq', '2').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    <>
        ...
        <View style={styles.root}>
            ...
            <View style={styles.blueSet}>
                ...
                {/* WORKOUT NAME */}
                <Text style={styles.name}>{workout.core[2].description}</Text>
            ...
            <View style={styles.whiteSet}>
                ...
                {/* WORKOUT DESCRIPTION */}
                {
                    ...
                    workout.standard[3].reps.map((item, index1) => {
                        if (selectedValue2 === workout.standard[4].name || selectedValue2 === workout.standard[5].name) {
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            ...
                            printPickerData(selectedValue2, workout.standard[3].name, setStandard4) :
                            selectedValue2 === workout.standard[4].name ?
                            printPickerData(selectedValue2, workout.standard[3].name, setStandard5) :
                            selectedValue2 === workout.standard[5].name ?
                            printPickerData(selectedValue2, workout.standard[3].name, setStandard6) :
                ...
                </View>
                {
                            ...
                            selectedValue2 === undefined && (standard4 !== '0') ? 
            ...
            <View style={styles.blueSet}>
                ...
                {/* WORKOUT NAME */}
                <Text style={styles.name}>{workout.standard[19].description}</Text>
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            ...
                            printPickerData(selectedValue3, workout.standard[6].name, setStandard9) :
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            selectedValue4 === workout.standard[9].name ?
                            printPickerData(selectedValue4, workout.standard[9].name, setStandard10) :
                            selectedValue4 === workout.standard[10].name ?
                            printPickerData(selectedValue4, workout.standard[9].name, setStandard11) :
                            

                            printPickerData(selectedValue4, workout.standard[10].name, setStandard10)
                        }}>
                        <RNIcon name="check-bold" color={'#1F7A8C'} size={25} style={{ paddingTop:20, marginRight:20}} />
                    </Pressable>
                </View>
                    {
                            selectedValue4 === workout.standard[9].name ?
                                renderNumOfTimes(selectedValue4, workout.standard[10].name, standard10) :
                            selectedValue4 === workout.standard[10].name ?
                                renderNumOfTimes(selectedValue4, workout.standard[11].name, standard11) :
                            
                            selectedValue4 === undefined && (standard10 !== '0') ? 
                ...
                <Dropdown
                    ...
                    placeholder={workout.standard[11].name}
                    onChange={item => {
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            ...
                            printPickerData(selectedValue5, workout.standard[11].name, setStandard12) :
                            selectedValue5 === workout.standard[12].name ?
                            printPickerData(selectedValue5, workout.standard[11].name, setStandard13) :
                    ...
                    {
                            selectedValue5 === workout.standard[11].name ?
                                renderNumOfTimes(selectedValue5, workout.standard[10].name, standard12) :
                            selectedValue5 === workout.standard[12].name ?
                                renderNumOfTimes(selectedValue5, workout.standard[11].name, standard13) :
                            
                            selectedValue5 === undefined && (standard12 !== '0') ? 
                                <Text style={{ textAlign:'right', marginRight:20, marginBottom:20 ,fontSize: 14}}>Number of Times Completed: {standard12}</Text>:
                            <Text style={{ textAlign:'right', marginRight:20, marginBottom:20 ,fontSize: 14}}>Number of Times Completed: {numberOfTimes}</Text>
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            ...
                            selectedValue6 === workout.standard[15].name ?
                            printPickerData(selectedValue6, workout.standard[13].name, setStandard16) :
                            selectedValue6 === workout.standard[16].name ?
                            printPickerData(selectedValue6, workout.standard[13].name, setStandard17) :
                ...
                </View>
                    {
                            ...
                            selectedValue6 === workout.standard[15].name ?
                                renderNumOfTimes(selectedValue6, workout.standard[15].name, standard16) :
                            selectedValue6 === workout.standard[16].name ?
                                renderNumOfTimes(selectedValue6, workout.standard[16].name, standard17) :
                ...
                />
                {/* WORKOUT NAME */}
                <Text style={styles.name}>{workout.standard[17].name}</Text>
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            printData(workout.standard[17].name, setStandard18);
                        }}>
                        <RNIcon name="check-bold" color={'#1F7A8C'} size={25} style={{ paddingTop:20, marginRight:20}} />
                    </Pressable>
                </View>
                <Text style={{ textAlign:'right', marginRight:20, marginBottom:20 ,fontSize: 14}}> Number of Times Completed: {standard18 !== '0'  ? standard18: numberOfTimes.toString() }</Text>
            ...
            <View style={styles.whiteSet}>
                ...
                />
                {/* WORKOUT NAME */}
                <Text style={styles.name}>{workout.standard[18].name}</Text>

                <Text style={{paddingTop: 20,paddingLeft: 15,color:'#8F979B', fontSize: 16}}> Sets x Reps / Weights </Text>

                {/* WORKOUT DESCRIPTION */}
                <Text style={styles.description}>{workout.standard[18].reps} 
                {''} {(Math.floor((bench * .81 * workout.standard[18].percentages)/5))*5} {'\n'}
                {workout.standard[18].description}</Text>
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            printData(workout.standard[18].name, setStandard19);
                        }}>
                        <RNIcon name="check-bold" color={'#1F7A8C'} size={25} style={{ paddingTop:20, marginRight:20}} />
                    </Pressable>
                </View>
                <Text style={{ textAlign:'right', marginRight:20, marginBottom:20 ,fontSize: 14}}> Number of Times Completed: {standard19 !== '0'  ? standard19: numberOfTimes.toString() }</Text>
