...
export default function ProgramItemSierraDay2 ({workout}){
    ...
    const dropdown8 = [
        ...
        { label: workout.standard[20].name, value: workout.standard[20].name},
    ]
    const dropdown9 = [
        { label: workout.standard[21].name, value: workout.standard[21].name},
        { label: workout.standard[22].name, value: workout.standard[22].name},
        { label: workout.standard[23].name, value: workout.standard[23].name},
    ]
    const dropdown10 = [
    ...
    const getUser = async () => {
        ...
        const newWeeks = await DataStore.query(WeeksCompleted, c => c.userID ('eq', authUser.attributes.sub).week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        const newLog4 = await DataStore.query(Logs, c => c.userID ('eq', authUser.attributes.sub).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[0].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[1].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[0].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[1].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[2].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[3].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[4].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[5].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[6].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[7].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[8].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[0].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[1].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[2].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[3].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.conditioning[4].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[0].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[1].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[2].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[3].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[4].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[5].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[6].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[7].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[8].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[9].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[10].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[11].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[12].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[13].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[14].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[15].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[16].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[17].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[18].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[19].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[20].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[21].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[22].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[23].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.standard[24].name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    const getDBUser = async (name, setValue) => {
        ...
        .workoutName('eq', name).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    const saveWeek = async () => { // THIS GO ON LAST DAY OF WEEK !!!!!!!!!!!!!!!!!!!
        ...
        const newWeeks = await DataStore.query(WeeksCompleted, c => c.userID ('eq', userID).week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        console.log(newWeeks)
        if (newWeeks) {
            let newResults = newWeeks.length.toString()
            console.log('got calculator')
    ...
    const save = async () => {
        ...
        const dbLog1 = await DataStore.query(Logs, c => c.userID ('eq', userID).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
        ...
        const newLog1 = await DataStore.query(Logs, c => c.userID ('eq', userID).day('eq', '4').week('eq', '1').program('eq', 'Sierra').level('eq', 'Elite'));
    ...
    <>
        ...
        <View style={styles.root}>
            ...
            <View style={styles.blueSet}>
                ...
                {/* WORKOUT NAME */}
                <Text style={styles.name}>{workout.core[9].description}</Text>
                ...
                <View style={{flexDirection:'row', flex:1}}>
                    ...
                    <Pressable
                        onPress={() => {
                            ...
                            printPickerData(selectedValue3, workout.standard[0].name, setStandard4) :
