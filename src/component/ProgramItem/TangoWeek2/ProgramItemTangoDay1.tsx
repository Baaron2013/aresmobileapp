...
export default function ProgramItemTangoDay1({workout}){
    ...
    const getUser = async () => {
        ...
        .workoutName('eq', workout.mobility[2].name).day('eq', '1').week('eq', '2').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.mobility[3].name).day('eq', '1').week('eq', '2').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[7].name).day('eq', '1').week('eq', '2').program('eq', 'Tango').level('eq', 'Elite'));
        ...
        .workoutName('eq', workout.core[8].name).day('eq', '1').week('eq', '2').program('eq', 'Tango').level('eq', 'Elite'));
